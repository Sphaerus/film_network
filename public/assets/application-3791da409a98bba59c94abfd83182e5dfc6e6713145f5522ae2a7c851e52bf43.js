...
(function() {
  $(document).ready(function() {
    $(document).on("mouseup", ".plus", function() {
      return $('.minus').mouseup(function() {
        return $(this).closest('.movie-select').remove();
      });
    });
    $('.plus').mouseup(function() {
      ...
      return $('.movies').append(new_input);
    });
    return $('.minus').mouseup(function() {
      return $(this).closest('.movie-select').remove();
    });
...
(function() {
  $(document).ready(function() {
    var i, j, len, len1, person, ref, ref1, role, select;
    ...
    $('.people .attribute.job select').change(function() {
      if ($(this).val() === "0") {
        return $(this).closest(".person-select").find(".role").removeClass("hidden");
      } else {
        return $(this).closest(".person-select").find(".role").addClass("hidden");
      }
    });
    ref1 = $(".people .person-select .attribute.role");
    for (j = 0, len1 = ref1.length; j < len1; j++) {
      role = ref1[j];
    ...
    $('.search_bar input').devbridgeAutocomplete({
      ...
      onSelect: function(suggestion) {
        var index, k, len2, new_input, ref2, size;
        ...
        $('.people .person-select.hidden .movie_movie_people_job select').val("0");
        $('.people .person-select.hidden .attribute.role input').removeClass("hidden");
        $('.people .person-select.hidden .attribute.role input').prop("disabled", false);
        ...
        return $('.minus').mouseup(function() {
          return $(this).closest('.person-select').remove();
        });
      }
    }, $(document).on('change', '.people .person-select .attribute.job select', function() {
      if ($(this).val() === "0") {
        $(this).closest(".person-select").find(".role").removeClass("hidden");
        return $(this).closest(".person-select").find(".role input").prop("disabled", false);
      } else {
        $(this).closest(".person-select").find(".role").addClass("hidden");
        return $(this).closest(".person-select").find(".role input").prop("disabled");
      }
    }));
    ...
    return $(document).ready(function() {
      return $('.user_score select').change(function() {
        var hash;
        hash = {
          "resource_type": "Movie",
          "resource_id": $('.id.hidden').data("id"),
          "score": $('.user_score select').val()
        };
        return $.ajax({
          dataType: "json",
          type: "post",
